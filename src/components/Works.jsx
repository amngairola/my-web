    ...
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        {/* <div className="mt-4 flex flex-wrap gap-2">
          {tags.map((tag) => (
            <p key={tag.name} className={`text-[14px] ${text.color}`}>
              #{tag.name}
            </p>
          ))}
        </div> */}
  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={styles.sectionHeadText}> Pojects.</h2>
      </motion.div>
      ...
      <div className="w-full flex">
        ...
        >
          In the project section of my website, I present a diverse portfolio
